/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ad96d00bfa6256f17de228750de2d235)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_API_ROOT_DOMAIN: string;
		SESSION_SECRET: string;
		CLOUDFLARE_TOKEN: string;
		CLOUDFLARE_ID: string;
		NEXT_PUBLIC_POSTHOG_KEY: string;
		NEXT_PUBLIC_POSTHOG_HOST: string;
		NEXT_PUBLIC_APPLY_EMAIL: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
		WORKER_SELF_REFERENCE: Fetcher /* linkr-audio */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_ROOT_DOMAIN" | "NEXT_PUBLIC_API_ROOT_DOMAIN" | "SESSION_SECRET" | "CLOUDFLARE_TOKEN" | "CLOUDFLARE_ID" | "NEXT_PUBLIC_POSTHOG_KEY" | "NEXT_PUBLIC_POSTHOG_HOST" | "NEXT_PUBLIC_APPLY_EMAIL">> {}
}
